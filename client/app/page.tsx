...
import { BookOpen, BarChart3, Database, ArrowRight } from 'lucide-react';
    ...
    <main className='min-h-screen bg-slate-50 relative overflow-hidden font-sans text-slate-900'>
      ...
      <div className='max-w-6xl mx-auto px-6 py-16'>
        ...
        <div className='text-center mb-20 space-y-4'>
          <div className='inline-block px-4 py-1.5 bg-blue-100 text-blue-700 text-sm font-semibold rounded-full mb-4 shadow-sm'>
            Big Data Project HK7
          </div>
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 gap-8 justify-center max-w-4xl mx-auto'>
          ...
          <div className='relative bg-slate-50 p-8 rounded-3xl border border-slate-200 opacity-70 grayscale hover:grayscale-0 hover:opacity-100 transition-all duration-500 cursor-not-allowed group'>
            <div className='flex items-start justify-between mb-6'>
              ...
              <span className='px-3 py-1 bg-slate-200 text-slate-500 text-xs font-bold uppercase tracking-wider rounded-full'>
                Coming Soon
              </span>
            </div>
            ...
            <div className='flex items-center text-slate-400 font-medium cursor-not-allowed'>
              Chưa khả dụng
            </div>
          </div>
        </div>
